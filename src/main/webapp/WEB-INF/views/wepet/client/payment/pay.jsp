...
function getpay() {
	...
	let params=rdays+"&"+petkinds+"&"+msg;
	console.log(msg+","+petkinds+","+rdays);
	...
	tossPayments.requestPayment(how, { // 결제 수단 파라미터
      ...
      successUrl: 'http://localhost:7777/payment/callback/success'+'?msg='+msg+'&petkinds='+petkinds+'&rdays='+rdays,
